export const SET_PROPERTY_VALUE_TYPE = 'SET_PROPERTY_VALUE_TYPE';
export const SET_PROPERTY_VALUE = 'SET_PROPERTY_VALUE';

export const setPropertyValueType = propertyValueType => ({
    type: SET_PROPERTY_VALUE_TYPE,
    payload: propertyValueType
});
