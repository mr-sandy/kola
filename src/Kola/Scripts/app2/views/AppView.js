define(function (require) {
    ...
    var LoadingView = require('app2/views/LoadingView');

    var homeHandler = require('app2/handlers/HomeHandler');
    var editTemplateHandler = require('app2/handlers/EditTemplateHandler');
