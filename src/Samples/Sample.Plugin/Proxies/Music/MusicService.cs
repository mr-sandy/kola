namespace Sample.Plugin.Proxies.Music
{
    ...
    public class MusicService : IMusicService
    {
        ...
        private static readonly Album PetSounds = new Album { Id = "13", Name = "Pet Sounds", ArtistId = TheBeachBoys.Id, ImageUrl = "http://www.bilborecords.be/sites/default/files/styles/large/public/Beach%20Boys%20-%20Smile%20Sessions_1.jpg?itok=jmDadcMY" };
        private static readonly Album Smile = new Album { Id = "14", Name = "Smile", ArtistId = TheBeachBoys.Id, ImageUrl = "http://media.bonnint.net/la/0/52/5228.jpg" };
