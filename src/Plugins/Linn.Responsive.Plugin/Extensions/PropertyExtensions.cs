            ...
            new Dictionary<string, Func<string, string>>
                {
                    ...
                    { "inner-type", v => BuildClassesFromList<ResponsiveType>(v, ResponsiveInnerTypeClassBuilder.BuildClasses) },
                    { "icon", v => EchoClass(v) },
                    ...
                    { "shadow", v => BuildClassesFromList<ResponsiveType>(v, c => string.Format("shadow-{0}-{1}", c.Type, c.Grid)) },
