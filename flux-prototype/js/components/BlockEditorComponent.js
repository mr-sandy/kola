    ...
    _renderWithoutChildren: function () {
        ...
        return (
            <li className={classes.join(' ')}
                ...
                <span className="chrome">{this.props.component.get('type')} - {this.props.component.get('name')} - {this.props.component.get('path').join('/')}</span>
            </li>
        );
    },
    ...
    _renderWithChildren: function () {
        ...
        return (
            <li className={classes.join(' ')}
                data-path={this.props.component.get('path')}
                onClick = {this._onItemClick}>
                <span className="chrome">{this.props.component.get('type')} - {this.props.component.get('name')} - {this.props.component.get('path').join('/')}
                    <button
                        className="collapse"
